...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<ProductSummaryResponseDTO> create(
			@RequestBody @Validated(ValidationSequence.class) ProductRequestDTO productRequest) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ProductSummaryResponseDTO> update(
			@RequestBody @Validated(ValidationSequence.class) ProductRequestDTO productRequest, @PathVariable Long id) {
		ProductSummaryResponseDTO response = this.productService.update(productRequest, id);
